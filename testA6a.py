...
#input = "bottle.cap"
input = '../scapy_tutorial/NewPcaps/TunnelCaps_2016/FTP/FTP-PlainTxT/FTovDNS-TextFile-dl-small.pcapng'
output = "extracted-6a.cap"
...
print('Length of decoded pktcap: ', len(E))
wrpcap(output, E)
